<template>
  <el-form :inline="true">
    ...
    <el-form-item label="u-turn distance penalty">
      <el-input-number size="mini" v-model="options.uTurnDistancePenalty" :min="0" controls-position="right"></el-input-number>
    </el-form-item>
  </el-form>
</template>
